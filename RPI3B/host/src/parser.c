...
int resnet18_run_tee[] = {2, 6, 8, 9, 11, 12, 14, 27, 28, -1};
// int vggbn_run_tee[] = {0, 3, 16, -1};
int vggbn_run_tee[] = {0, -1};
int resnet50_run_tee[] = {0, 2, 3, 6, 7, 14, 15, 22, 23, 27, 64, 67, 68, -1};
#endif
