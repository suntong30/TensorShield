...
def run():
    ...
    archs = ['resnet18']
    final_result_path = os.path.join(os.getcwd(), 'ms_elastictrainer_result_cifar100_stl10_resnet18.csv')
    #final_result_path = os.path.join(os.getcwd(), 'ms_elastictrainer_result_vgg16.csv')
