...
IMPORTANCE_PATH_TEMPLATE = '/home/gpu2/jbw/other_XAI_grad/knockoffnets/models/victim/{}/.importance.txt'
model_names = [
    "cifar10-resnet18",
    ...
    "cifar100-resnet50",
    "cifar10-resnet50",
    "tinyimagenet200-resnet50",
    "stl10-resnet50",
    "stl10-mobilenetv2"
    ]
protected_layer_ratios = {
    "cifar100-vgg16_bn": [0.6, 1],
    "cifar10-resnet18": [0.9, 1],
    "cifar100-mobilenetv2": [0.8, 1],
    "cifar10-vgg16_bn": [0.5, 1],
    "cifar10-mobilenetv2": [0.2, 1],
    "tinyimagenet200-resnet18": [0.95, 1],
    "tinyimagenet200-vgg16_bn": [0.95, 1],
    "tinyimagenet200-mobilenetv2": [0.95, 1],
    "cifar100-resnet50": [0.95, 1],
    "cifar10-resnet50": [0.9, 1],
    "tinyimagenet200-resnet50": [1, 1],
    "stl10-resnet50": [0.8, 1],
    "stl10-mobilenetv2": [0.8, 1],
}
