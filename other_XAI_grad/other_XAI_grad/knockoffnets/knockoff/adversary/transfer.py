...
import torchvision
import sys
sys.path.append('/home/gpu2/jbw/other_XAI_mean/knockoffnets')
...
def main():
    ...
    if "vgg" in out_path or "alex" in out_path:
