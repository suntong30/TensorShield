...
IMPORTANCE_PATH_TEMPLATE = '/home/gpu2/jbw/other_XAI_mean/knockoffnets/models/victim/{}/.importance.txt'
model_names = [
    "cifar10-resnet18",
...
protected_layer_ratios = {
    "cifar100-vgg16_bn": [0.7, 1],
    "cifar10-resnet18": [0.7, 1],
    "cifar100-mobilenetv2": [0.7, 1],
    "cifar10-vgg16_bn": [0.7, 1],
    "cifar10-mobilenetv2": [0.1, 1],
    "tinyimagenet200-resnet18": [0.8, 1],
    "tinyimagenet200-vgg16_bn": [0.4, 1],
    "tinyimagenet200-mobilenetv2": [0.9, 1],
    "cifar100-resnet50": [0.95, 1],
    "cifar10-resnet50": [0.5, 1],
    "tinyimagenet200-resnet50": [0.95, 1],
    "stl10-resnet50": [0.1, 1]
}
