...
IMPORTANCE_PATH_TEMPLATE = '/home/gpu2/jbw/other_XAI_positive/knockoffnets/models/victim/{}/.importance.txt'
model_names = [
    "cifar10-resnet18",
...
protected_layer_ratios = {
    "cifar100-vgg16_bn": [0.5, 1],
    "cifar10-resnet18": [1, 1],
    "cifar100-mobilenetv2": [0.4, 1],
    "cifar10-vgg16_bn": [0.4, 1],
    "cifar10-mobilenetv2": [0.6, 1],
    "tinyimagenet200-resnet18": [0.2, 1],
    "tinyimagenet200-vgg16_bn": [0.3, 1],
    "tinyimagenet200-mobilenetv2": [0.5, 1],
}
